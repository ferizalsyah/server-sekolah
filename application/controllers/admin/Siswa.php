...
class Siswa extends CI_Controller {
	...
	{
		$isi['content']		= 'admin/siswa/content_siswa';
		$isi['judul']		= 'Referensi';
		$isi['sub_judul']	= 'Data Kampus';
		$isi['kampus'] 		= $this->db->get('tb_siswa');
	...
	public function simpan()
	{
		...
		?>
          ...
          <script type="text/javascript">alert("Tambah data siswa berhasil."); window.location.href="<?php echo base_url();?>admin/siswa"</script> <?php
	}
	...
	public function hapus($id_siswa)
	{
		...
		?>
			<!-- muncul peringatan kalau login gagal dan langsung kembali ke halaman login.php-->
          <script type="text/javascript">alert("hapus data siswa berhasil."); window.location.href="<?php echo base_url();?>index.php/admin/siswa"</script> <?php
	}
	...
	?>
			<!-- muncul peringatan kalau login gagal dan langsung kembali ke halaman login.php-->
          <script type="text/javascript">alert("Update data kampus berhasil."); window.location.href="<?php echo base_url();?>/admin/siswa"</script> <?php
}
